        ...
        VStack{
            ...
            HStack{
                ...
                VStack(alignment:.leading,spacing: 24) {
                    ...
                    HStack{
                        if let location = vm.selectedUberLocation{
                            Text(location.title)
                                .font(.system(size: 16,weight: .semibold))
                        }
                        Spacer()
            ...
            ScrollView(.horizontal,showsIndicators: false){
                HStack(spacing:12){
                    ForEach(RideType.allCases){ item in
                        ...
                        .foregroundColor(selectedRideType == item ? .white : Color.theme.textColor)
                        .background(selectedRideType == item ? .blue : Color.theme.secondaryBgColor)
